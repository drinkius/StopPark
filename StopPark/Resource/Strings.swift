...
struct Strings {
    ...
    static func generateTemplateText(date: String, auto: String, number: String, address: String, photoDate: String, eventViolation: String?, imageCount: Int = 0) -> String {
        ...
        Прилагаю фотографии машины (\(count)), сделанные мной \(photoDate).
...
enum Str {
    enum Generic {
        ...
        static let errorNoImage: String = "Сначала загрузите фотографии."
    ...
    enum Home {
        static let noStatements: String = "У Вас нет пока что обращений, но Вы можете подать новое"
    ...
    enum Form {
        ...
        static let addMoreImages: String = "Добавить еще фотографии"
        ...
        static let enterCode: String = "Введите код"
        static let requestingCode: String = "Запрашиваем подтверждение email"
        static let checkingCode: String = "Проверяем код"
        static let verifyEmail: String = "Введите код подтверждения email (к сожалению, это нужно делать с каждым запросом, письмо должно прийти на указанную почту)"
        static let notARobot: String = "Подтвердите, что вы не робот"
        ...
        static let sendingToServer: String = "Отправляем запрос на сервер..."
    ...
    enum Settings {
        ...
        static let sectionAdditional: String = "Дополнительно"
        static let rowPrivacy: String = "Профиль"
        static let rowInfo: String = "Информация о подаче заявления"
    ...
    enum Pay {
        ...
        static let donateMotivationText1: String = "Улучшайте город вместе с нами!"
        static let donateMotivationText2: String = "Становитесь частью сообщества, которому не все равно на город и общественность!"
        static let donateMotivationText3: String = "Поддержите разработку приложения и команду данного проекта!"
