...
protocol TimePickerCellDelegate: class {
    func cell(_ cell: TimePickerCell, formData data: FormData?, didChangedTimeTo time: String?)
}

class TimePickerCell: BaseGroupedTableViewCell {
    
    public func fill(with data: FormData, dataCount: Int, cellIndex: Int, delegate: TimePickerCellDelegate) {
    ...
    private weak var delegate: TimePickerCellDelegate?
...
extension TimePickerCell: UITextFieldDelegate {
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        textField.text = formatter.string(from: pickerView.date)
        delegate?.cell(self, formData: formData, didChangedTimeTo: textField.text)
        textField.resignFirstResponder()
        return true
    }
